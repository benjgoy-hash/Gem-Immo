...
ROOMS_PATTERN_PLUS = re.compile(r"(\d+)-pi(?:e|è)ces?-et-plus")
ROOMS_PATTERN_MINUS = re.compile(r"(\d+)-pi(?:e|è)ces?-et-moins")
ROOMS_PATTERN_RANGE = re.compile(r"de-(\d+)-a-(\d+)-?pi(?:e|è)ces?")
ROOMS_PATTERN_SINGLE = re.compile(r"(\d+)-pi(?:e|è)ces?")
